...
# -*- coding: utf-8 -*-
"""
咸鱼传媒 - 四壳通用Python Spider
站点：https://pvo.xycm6.skin/xycm/
结构：苹果CMS
"""
import re
...
class Spider(Spider):
    def init(self, extend=""):
        self.siteUrl = "https://pvo.xycm6.skin"
    ...
    def homeContent(self, filter):
        ...
        classes = [
            ...
            {"type_name": "唯美视频", "type_id": "22"},
            {"type_name": "口交视频", "type_id": "23"},
            {"type_name": "日本有碼", "type_id": "24"},
            {"type_name": "日本無碼", "type_id": "25"},
            {"type_name": "动漫视频", "type_id": "26"},
            {"type_name": "欧美视频", "type_id": "27"},
        ]
        ...
        videos = []
        items = re.findall(
            r'<article[^>]*>.*?<a[^>]*href="/(\d+\.html)"[^>]*title="([^"]*)".*?<img[^>]*src="([^"]*)"',
            html, re.S
        )
