# -*- coding: utf-8 -*-
"""
销魂洞 - 四壳通用Python Spider
站点: https://knr.xhd5.wiki
"""
...
class Spider(Spider):
    domain = "https://knr.xhd5.wiki"
    siteName = "销魂洞"
    CATEGORIES = [("20","自拍偷拍"),("21","巨乳波霸"),("22","强奸乱伦"),("23","人妻熟女"),("24","制服丝袜"),("25","花季少女"),("26","无码露毛"),("27","群P多人"),("28","人兽人妖"),("29","男同女同")]
    ...
    def _parse_list(self, html):
        ...
        # video-play结构
        items = re.findall(r'<div class="video-play">(.*?)</div>\s*</div>', html, re.S)
        for item in items:
            ...
            # 标题
            name = ""
            t = re.search(r'<p class="title-p"><a[^>]*>(.*?)</a></p>', item, re.S)
            if t:
